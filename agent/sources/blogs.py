...
# Verified live 2026-09-08. Uber's engineering feed was in the original design list but
# 404s now (406 to a bot UA) — replaced with Meta's, the closest equivalent.
FEEDS = [
...
LIMIT = 5
PER_FEED = 3          # cap before merging, so one prolific feed can't take the whole quota
TIMEOUT = 20.0
